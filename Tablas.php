...
<title>Inventario</title>
  ...
  function borrar() {
    return window.confirm( '¿Está seguro que desea Borrar éste registro?' );
  }
</script>

<form action='borrarp.php' onsubmit="return borrar()" method="post">
  <!-- tus otros inputs -->
  <input type='hidden' name='id_proyecto' value='<?php echo $mostrar['idProyecto'];?>'>
  <input type="submit" name="submitBorrar" class="btn btn-outline-danger" value="Borrar">
</form>
      </td>
        </td>
      ...
      <input type='hidden' name='id_proyecto' value='<?php echo $mostrar['idProyecto'];?>'>
      <input  type='submit' class="btn btn-outline-warning" value='Imprimir'>
      </form>
      </td>
        </td>
        		</tr>
